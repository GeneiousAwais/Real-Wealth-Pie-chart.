 ...
 <style type="text/css">
    ...
    margin-left: -271px !important;
 	...
 	.body-cover {
 		background-image: url('<?= base_url().$cover->path; ?>');
 ...
 <div class="main-content">
 		...
 		<div class="container-fluid">
 			<form method="POST" id="questionnaireForm" action="<?= base_url('save-questionnaire');?>" class="needs-validation" novalidate>
 				<?php if(isset($questions)){?>
 						<div class="row mt-5">
 							<div class="offset-xl-2 col-xl-8 mt-5 main_div ">
 								<?php 
											...
											<div class="card-body border-top">
												<div class="row">
													<div class="col-md-12">
														...
														<div class="area font-size-13 border-0">Unsatisfied</div>
														...
														<div class="area font-size-13 border-0">Completely Satisfied</div>
							...
							<div class="offset-xl-3 col-xl-6 mt-5 user-form d-none">
								<div class="card">
									<div class="card-body">
							...
							<div class="col-md-6 mt-5 preview_chart d-none">
								<div class="container">
									<div class="card">
										<div class="card-body border-top">
											<div id="chart" class="">
	...
	<script type="text/javascript">
		...
		let ctx = document.getElementById("preview_canvas").getContext("2d");
		data = {
			datasets: [{
		...
		$(document).on('click', '.rating-star', function(e){
			...
			var index = curr_id-1;
			myPolarAreaChart.data.datasets[0].data[index] = option;
